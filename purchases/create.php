...
$products = $pdo->query("SELECT id, name, purchase_price, quantity FROM products WHERE status=1 ORDER BY name")->fetchAll();
include '../includes/header.php';
?>
<h1>New Purchase</h1>
<form id="purchaseForm" method="post" action="store.php">
    <div class="row mb-3">
        <div class="col-md-4">
